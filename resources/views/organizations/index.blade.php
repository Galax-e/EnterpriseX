            ...
            <div class="col-sm-8">
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <h2>Organizations</h2>
                        <p>
                            All Organizations need to be verified before you can send email and set a project.
                        </p>
                        <div class="input-group">
                            <input type="text" placeholder="Search organization " class="input form-control">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a data-toggle="tab" href="#tab-2"><i class="fa fa-briefcase"></i> Companies</a></li>
                            <li class=""><a data-toggle="tab" href="#tab-1"><i class="fa fa-user"></i> Contacts</a></li>
                        </ul>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover">
                                            ...
                                            @foreach($user_orgs as $user_org)
                                                <tr>
                                                    <td class="client-avatar"><img alt="image" src="{{asset('img/profile_pix/'.$user_org->avatar)}}"> </td>
                                                    <td><a data-toggle="tab" href="#contact-{{$loop->index + 1}}" class="client-link">{{$user_org->user->name}}</a></td>
                                                    <td> {{$user_org->name}}</td>
                                                    <td class="contact-type"><i class="fa fa-envelope"> </i></td>
                                                    <td> {{$user_org->user->email}}</td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover">
                                            ...
                                            @foreach($user_orgs as $key => $user_org)
                                                <tr>
                                                    <td><a data-toggle="tab" href="#company-{{$loop->index + 1}}" class="client-link">{{$user_org->name}}</a></td>
                                                    <td>{{$user_org->user->name}}</td>
                                                    <td><i class="fa fa-flag"></i> {{$user_org->country}}</td>
                                                    <td class="client-status">
                                                        <span class="label label-primary">
                                                             {{$key}}
                                                        </span>
                                                        <a href="{{url('organizations/'.$user_org->id)}}">
