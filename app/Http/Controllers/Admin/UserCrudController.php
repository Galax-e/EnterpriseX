...
use Backpack\PermissionManager\app\Http\Controllers\UserCrudController as ParentCrudController;

class UserCrudController extends ParentCrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setColumns([
            ...
            [
                'name'  => 'username',
                'label' => 'Username', //trans('backpack::permissionmanager.name'),
                'type'  => 'text',
            ],
            [
                'name'  => 'email',
